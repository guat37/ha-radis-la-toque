...
class RadisLaToqueEntity(CoordinatorEntity[RadisLaToqueCoordinator]):
    ...
    def __init__(self, coordinator: RadisLaToqueCoordinator) -> None:
        ...
        self._attr_device_info = DeviceInfo(identifiers={(DOMAIN, coordinator.entity_prefix)}, name=coordinator.restaurant_name, manufacturer="RESTORIA / Radis la Toque", configuration_url=coordinator.restaurant_url)
