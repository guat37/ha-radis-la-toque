...
4. Créer une GitHub Release `v0.4.0-beta.1`.
...
La carte est embarquée dans `custom_components/radis_la_toque/www/`. L'intégration la sert via `/radis_la_toque/radis-la-toque-card.js`. Pour la bêta, l'ajout de la ressource Lovelace reste volontairement explicite et documenté afin de ne pas modifier automatiquement les dashboards de l'utilisateur.
